...
<body>
    ...
    @if ($rekap == 'hari')
        ...
        @endif
    @elseif ($rekap == 'minggu')
        <h3>Periode: {{ now('Asia/Jakarta')->startOfWeek()->format('d-m-Y') }} -
            {{ now('Asia/Jakarta')->endOfWeek()->format('d-m-Y') }}</h3>
        @if (count($absensi) > 0)
            <table class="table table-striped">
                <thead>
                    <tr>
        ...
        @endif
    @elseif ($rekap == 'bulan')
        <h3>Periode: {{ now('Asia/Jakarta')->startOfMonth()->format('d-m-Y') }} -
            {{ now('Asia/Jakarta')->endOfMonth()->format('d-m-Y') }}</h3>
        @if (count($absensi) > 0)
            <table class="table table-striped">
                <thead>
                    <tr>
