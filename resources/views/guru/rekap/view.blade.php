            ...
            <div class="card-header">
                ...
                @if (count($absensi) > 0)
                    <div class="card-header-action">
                        <a href="{{ route('guru.rekap.download', ['rekap' => $rekap, 'kelas_id' => $kelas->id, 'jadwal_id' => $absensi[0]->jadwal->id, 'start_date' => $start_date, 'end_date' => $end_date, 'format' => 'pdf']) }}"
                            class="btn btn-primary">Download PDF</a>
                    </div>
                    <div class="card-header-action">
                        <a href="{{ route('guru.rekap.download', ['rekap' => $rekap, 'kelas_id' => $kelas->id, 'jadwal_id' => $absensi[0]->jadwal->id, 'start_date' => $start_date, 'end_date' => $end_date, 'format' => 'excel']) }}"
